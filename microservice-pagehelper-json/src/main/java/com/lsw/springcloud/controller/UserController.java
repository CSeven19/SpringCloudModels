...
public class UserController {
	...
	@RequestMapping(value = "/getUser/listbypagehelper", method = RequestMethod.GET)
	public JSONArray getUsersByPageHelper() {
		PageResultBean<User> users = service.selectUser();
