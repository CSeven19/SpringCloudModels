...
import com.lsw.springcloud.entity.UserVo;
import com.lsw.springcloud.redis.RedisKeyUtil;
import com.lsw.springcloud.redis.RedisService;

@RunWith(SpringRunner.class) // SpringRunner.class就是SpringJUnit4ClassRunner，此处是指定junit4来运行测试.
